...
const fetchDataFromAPI = async (api) => {
  try {
    ...
    return response.data; // Assuming response.data is an array or object with relevant data
  } catch (error) {
    ...
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
      ...
      <Grid item xs={12} sx={{ mb: -2.25 }}>
        ...
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <AnalyticEcommerce
            title={`Total Services ${serviceData.length}`}

          />
        </Grid>
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <AnalyticEcommerce
            title={`Total Blogs ${blogData.length}`}
        ...
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <AnalyticEcommerce
            title={`Total Jobs ${jobData.length}`}
        ...
        <Grid item xs={12} sm={6} md={4} lg={3}>
          <AnalyticEcommerce
            title={`Total Teams ${teamData.length}`}
